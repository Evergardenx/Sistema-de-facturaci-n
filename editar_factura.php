...
$active_clientes = "";
$active_usuarios = "";
$title = "Editar Pedido | Simple Invoice";

/* Connect To Database */
require_once("config/db.php");
require_once("config/conexion.php");
date_default_timezone_set('America/Asuncion'); // Establecer el timezone a Asunción, Paraguay (UTC-4)
...
<div class="container">
    <div class="panel panel-info">
        ...
        <div class="panel-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-3">
                        <input type="text" class="form-control input-sm" id="nombre_cliente"
                               placeholder="Selecciona un cliente" required value="<?php echo $nombre_cliente; ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <select class='form-control input-sm ' id="estado_factura" name="estado_factura">
                            ...
                            <option value="2" <?php if ($estado_factura == 2) {
                                echo "selected";
                            } ?>>Pendiente
                            </option>
                        </select>
                ...
                <div class="col-md-12">
                    <div class="pull-right">
                        ...
                        <button type="button" class="btn btn-default" data-toggle="modal" data-target="#nuevoCliente">
                            <span class="glyphicon glyphicon-user"></span> Nuevo encargado
                        </button>
                        <button type="button" class="btn btn-default" data-toggle="modal" data-target="#myModal">
                            <span class="glyphicon glyphicon-search"></span> Agregar insumos
                        </button>
            ...
            <div class="editar_factura col-md-12" style="margin-top:10px"></div><!-- Carga los datos ajax -->
