...
<img src="images/unves.png" title="Desarrollador: Ulises Cenoz Zacarías" height="100" style="width: 100px; margin-top: 0px; top: 20px; left: 5px; background-color: navy; position: absolute; border-radius: 1500px; box-shadow: 0 0 100px 80px #03008F;">
    <link href="css/bootstrap-responsive.css" rel="stylesheet">
</head>
<body>
 <div class="container">
        <div class="card card-container">
            <img id="profile-img" class="profile-img-card" src="img/unves.png" />
